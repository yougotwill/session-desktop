...
export const windowsCrash: ThemeColorVariables = {
  '--danger-color': THEMES.WINDOWS_CRASH.DANGER,
  '--disabled-color': THEMES.WINDOWS_CRASH.DISABLED,

  '--background-primary-color': THEMES.WINDOWS_CRASH.COLOR1,
  '--background-secondary-color': THEMES.WINDOWS_CRASH.COLOR0,

  '--text-primary-color': THEMES.WINDOWS_CRASH.COLOR6,
  '--text-secondary-color': THEMES.WINDOWS_CRASH.COLOR5,
  '--text-selection-color': `rgba(${hexColorToRGB(THEMES.WINDOWS_CRASH.COLOR6)}, 0.5)`,

  '--border-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--message-bubbles-received-background-color': THEMES.WINDOWS_CRASH.COLOR2,
  ...
  '--menu-button-background-hover-color': THEMES.WINDOWS_CRASH.COLOR4,
  '--menu-button-icon-color': THEMES.WINDOWS_CRASH.COLOR6,

  '--chat-buttons-background-color': THEMES.WINDOWS_CRASH.COLOR2,
  '--chat-buttons-background-hover-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--chat-buttons-icon-color': 'var(--text-primary-color)',

  '--settings-tab-background-color': 'var(--background-primary-color)',
  '--settings-tab-background-hover-color': THEMES.WINDOWS_CRASH.COLOR2,
  '--settings-tab-background-selected-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--button-solid-background-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--button-solid-background-hover-color': THEMES.WINDOWS_CRASH.COLOR4,
  '--button-solid-text-color': 'var(--text-primary-color)',
  '--button-solid-text-hover-color': 'var(--text-primary-color)',
  '--button-solid-disabled-color': THEMES.WINDOWS_CRASH.COLOR4,
  ...
  '--conversation-tab-background-hover-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--conversation-tab-background-selected-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--conversation-tab-background-unread-color': THEMES.WINDOWS_CRASH.COLOR2,
  ...
  '--conversation-tab-bubble-background-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--scroll-bar-thumb-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--scroll-bar-thumb-hover-color': THEMES.WINDOWS_CRASH.COLOR4,

  '--zoom-bar-track-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--unread-messages-alert-text-color': THEMES.WINDOWS_CRASH.COLOR0,
  ...
  '--emoji-reaction-bar-background-color': THEMES.WINDOWS_CRASH.COLOR2,
  ...
  '--right-panel-item-background-color': THEMES.WINDOWS_CRASH.COLOR2,
  '--right-panel-item-background-hover-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--suggestions-background-color': THEMES.WINDOWS_CRASH.COLOR2,
  '--suggestions-background-hover-color': THEMES.WINDOWS_CRASH.COLOR3,
  ...
  '--call-buttons-background-color': THEMES.WINDOWS_CRASH.COLOR3,
  '--call-buttons-background-hover-color': THEMES.WINDOWS_CRASH.COLOR4,
  '--call-buttons-background-disabled-color': THEMES.WINDOWS_CRASH.COLOR2,
