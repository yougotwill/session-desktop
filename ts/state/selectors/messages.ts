...
export const useMessageIsDeletableForEveryone = (messageId: string | undefined): boolean => {
  return useMessageIdProps(messageId)?.propsForMessage.isDeletableForEveryone || false;
};
